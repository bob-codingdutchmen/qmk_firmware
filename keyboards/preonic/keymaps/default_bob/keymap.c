...
[_COLEMAK] = LAYOUT_preonic_grid( \
  ...
  OSM(MOD_LSFT), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_ENT), \
  TT(_NUMPAD), KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,S(KC_NUHS),KC_LCBR,KC_RCBR, KC_PERC, LGUI(KC_ENT), \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_LBRC, KC_RBRC, KC_PGDN, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______ \
),
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_SCROLLLOCK, KC_PAUSE, _______ \
),
